...
const Searcher = ({ className = "", placeholder = "microphones", main = false }) => {
  return (
    <div className={`w-3/5 h-max pl-3 rounded-3xl bg-gray-300 ${main ? "mb-3 mx-auto" : "inline-block ml-[clamp(0px,9vw,57px)]"} ${className}`}>
